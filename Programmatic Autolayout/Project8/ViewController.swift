...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        currentAnswer.backgroundColor = .orange
        ...
        buttonsView.layer.borderColor = UIColor.red.cgColor
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Try Again :(", message: "Your answer is wrong", preferredStyle: .alert)
